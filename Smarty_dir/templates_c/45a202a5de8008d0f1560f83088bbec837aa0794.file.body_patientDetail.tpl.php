<?php /* Smarty version Smarty-3.1.18, created on 2015-01-09 11:38:20
         compiled from "Smarty_dir\templates\body_patientDetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2954254afaf9c0fc0e5-15522389%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2954254afaf9c0fc0e5-15522389',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54afaf9c174049_69350782',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54afaf9c174049_69350782')) {function content_54afaf9c174049_69350782($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
	<head>
 ...
 <?php echo $_smarty_tpl->tpl_vars['info']->value['surname'];?>
	...
	<br>
		...
		<button type="submit" formaction="index.php?control=manageDB&action=modify&pat=<?php echo md5($_smarty_tpl->tpl_vars['info']->value['CF']);?>
...
">stampa report</button>
		<button type="submit" formaction="index.php?control=manageDB&action=delete&pat=<?php echo md5($_smarty_tpl->tpl_vars['info']->value['CF']);?>
&ch=<?php echo md5($_smarty_tpl->tpl_vars['info']->value['dateCheck']);?>
">cancella</button>
	</form>
<?php }} ?>
