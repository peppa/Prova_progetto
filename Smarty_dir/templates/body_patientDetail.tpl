...
<html>
	...
	<br>
		...
		<button type="submit" formaction="index.php?control=manageDB&action=modify&pat={md5($info.CF)}&ch={md5($info.dateCheck)}">modifica</button>
		...
		<button type="submit" formaction="index.php?control=manageDB&action=delete&pat={md5($info.CF)}&ch={md5($info.dateCheck)}">cancella</button>
	</form>
